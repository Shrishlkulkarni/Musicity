...
public class login extends AppCompatActivity {
    ...
    private Button login, lreg;
    ImageView logo3,logo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button xbutton = (Button) findViewById(R.id.xbut);
        ...
        if(sharedPreferences.contains(Email)){
            ...
            ActivityOptions options = ActivityOptions.makeCustomAnimation(this,R.anim.slide_left_to_right,R.anim.slide_out_from_left);
                ...
                mAuth.signInWithEmailAndPassword(newemail,pass)
                        .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                            ...
                            public void onSuccess(AuthResult authResult) {
                                ...
                                ActivityOptions options = ActivityOptions.makeCustomAnimation(getBaseContext(),R.anim.slide_left_to_right,R.anim.slide_out_from_left);
                                startActivity(new Intent(login.this, home.class));
                                finish();
                            }
